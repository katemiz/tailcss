    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between">
            <div class="flex space-x-4">
                <a href="/" class="flex items-center py-5 px-2 text-yellow-400 hover:text-yellow-300">
                ...
                <a href="/" class="flex items-center py-5 px-2 text-blue-500 hover:text-blue-400">
                    <span>PDM</span>
                </a>
            </div>
...
{{-- <nav class="bg-gray-200 border-4 border-gray-200 dark:bg-gray-900 dark:border-gray-700">

    <div class="flex flex-col sm:flex-row">

        <div class="flex-none bg-amber-300 px-2 py-3">
        ...
        <div class="flex-none bg-blue-800 px-2 py-3">
            <a href="#" class="flex items-center space-x-3 text-white  rtl:space-x-reverse">
                PDM
            </a>
        </div>
        ...
        <div class="flex-none bg-gray-800 hidden w-full md:block md:w-auto" id="navbar-dropdown">
            <ul class="flex flex-col  md:flex-row md:mt-0">
              <li>
                <a href="#" class="block py-2 px-3 text-white bg-blue-700 md:bg-transparent md:text-blue-200 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page">Home</a>
              </li>
...
{{--
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between mx-auto p-4 bg-gray-500">
        ...
        <div class="flex items-center space-x-3 rtl:space-x-reverse bg-amber-500">
        ...
        <div class="flex items-center space-x-3 rtl:space-x-reverse bg-blue-500">
        ...
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <button type="button" class="flex text-sm bg-gray-200 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                ...
                <img class="w-8 h-8 rounded-full" src="https://masttech.net/images/model.svg" alt="user photo">
            </button>
            <!-- Dropdown menu -->
  ...
  {{-- <header class="bg-red-300">
    ...
    <nav class="flex justify-between items-center w-[98%] mx-auto">

        <div>AAAA</div>

        <div class="bg-amber-300 min-h-[60vh]">
            <ul class="flex flex-col md:flex-row items-center gap-[4vw]">
                <li>
        ...
        <div>
            <button class="rounded-full hover:text-blue-700">Sign In</button>
        </div>
